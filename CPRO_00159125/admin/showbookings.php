...
<?php include '../templates/header.php';
	...
	if(isset($_GET['dnid'])){
		...
		$con= connect();
		$sql= "DELETE FROM `booking` WHERE `bid`= '$deid'";
		$resultData=$con->query($sql);
		$msg1 ='Appointment has been deleted successfully.\n';
		$message=$msg1;
                            ...
                            <nav class="navbar h-100 navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse" id="medilifeMenu">
                                    ...
                                    <ul class="navbar-nav ml-auto">
										...
										<li class="nav-item active"><a class="nav-link" href="showbookings.php">Show Bookings</a></li>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Bookings</h3>
		...
		<div class="row">
			<table class="table table-striped">
				...
				<tr>
					...
					<td><?=$row['time']?></td>
					<td><?=$row['number']?></td>
					<td><a href="<?=BASE_URL?>/admin/showbookings.php?dnid=<?=$row['bid']?>" class="btn btn-primary">Delete</a></td>
				</tr>
				<?php  } ?>				
			</table>
		</div>
